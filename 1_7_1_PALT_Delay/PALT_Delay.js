...
function answerRoutineEnd(snapshot) {
  return async function () {
    ...
    thisFilename = psychoJS.experiment.dataFileName.substring(7) + '_' + 'recording_mic_' + currentLoop.name + '_' + currentLoop.thisN
    // get the recording
...
async function quitPsychoJS(message, isCompleted) {
  ...
  window.location.href = "https://experiment.psych.ac.cn/wellbeing"; // 回到下段启动页面
