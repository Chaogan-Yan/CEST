...
function LoopSelectFreqNumberLoopBegin(LoopSelectFreqNumberLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoopSelectFreqNumber of LoopSelectFreqNumber) {
...
function colorLoopLoopBegin(colorLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisColorLoop of colorLoop) {
...
function shapeLoopLoopBegin(shapeLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisShapeLoop of shapeLoop) {
...
function ShapeBoatExRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ShapeBoatExComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ShapeRabbitExRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ShapeRabbitExComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function InterTrial_IntrevalRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of InterTrial_IntrevalComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ISIcodeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ISIcodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function CueShapeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CueShapeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function UpdateAccuracyRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of UpdateAccuracyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function continueStatusRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of continueStatusComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ColorRedExRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ColorRedExComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ColorBlueExRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ColorBlueExComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function CueColorRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CueColorComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Stim2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Stim2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function UpdateAccuracy2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of UpdateAccuracy2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ContStatus2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ContStatus2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function CombInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CombInstructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function countResetRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of countResetComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ITI_CombRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ITI_CombComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function FixationComb_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of FixationComb_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function cueComb_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of cueComb_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PracticeComb_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PracticeComb_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function stopColorLoopRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of stopColorLoopComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function cueComb_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of cueComb_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function stopShapeLoopRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of stopShapeLoopComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
async function quitPsychoJS(message, isCompleted) {
  ...
  window.location.href = "https://experiment.psych.ac.cn/language"; // 回到下段启动页面
