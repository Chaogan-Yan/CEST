...
async function updateInfo() {
  ...
  psychoJS.experiment.dataFileName = (("." + "/") + `data/1_1_1_${expName}_${expInfo["\u7f16\u53f7"]}_${expInfo["date"]}`);
...
function dummy_trialLoopBegin(dummy_trialLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisDummy_trial of dummy_trial) {
...
function blocknLoopBegin(blocknLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisBlockn of blockn) {
...
function dummy_resourcesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of dummy_resourcesComponents)
...
function JS_codeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of JS_codeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instruction_2_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instruction_2_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instruction_2_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instruction_2_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instruction_2_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instruction_2_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instruction_2_4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instruction_2_4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instruction_2_5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instruction_2_5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Main_Exp_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Main_Exp_InstructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
