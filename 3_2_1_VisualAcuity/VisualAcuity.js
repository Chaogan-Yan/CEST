...
let expName = 'VisualAcuity';  // from the Builder filename that created this script
let expInfo = {
    '编号': '',
    '主试ID': '',
};
...
flowScheduler.add(scale_set_upRoutineBegin());
flowScheduler.add(scale_set_upRoutineEachFrame());
flowScheduler.add(scale_set_upRoutineEnd());
flowScheduler.add(screen_scale_keysRoutineBegin());
flowScheduler.add(screen_scale_keysRoutineEachFrame());
flowScheduler.add(screen_scale_keysRoutineEnd());
flowScheduler.add(rectangle_keysRoutineBegin());
flowScheduler.add(rectangle_keysRoutineEachFrame());
flowScheduler.add(rectangle_keysRoutineEnd());
...
flowScheduler.add(outputRoutineBegin());
flowScheduler.add(outputRoutineEachFrame());
flowScheduler.add(outputRoutineEnd());
...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'Line_resources/loop1.xlsx', 'path': 'Line_resources/loop1.xlsx'},
    {'name': 'Image/E_right.png', 'path': 'Image/E_right.png'},
    {'name': 'Image/E_left.png', 'path': 'Image/E_left.png'},
    {'name': 'Image/E_up.png', 'path': 'Image/E_up.png'},
    {'name': 'Image/E_down.png', 'path': 'Image/E_down.png'},
    {'name': 'Image/bank-1300155_640.png', 'path': 'Image/bank-1300155_640.png'},
    {'name': 'default.png', 'path': 'https://pavlovia.org/assets/default/default.png'},
    {'name': 'Line_resources/line53.xlsx', 'path': 'Line_resources/line53.xlsx'},
    {'name': 'Line_resources/line52.xlsx', 'path': 'Line_resources/line52.xlsx'},
    {'name': 'Line_resources/line51.xlsx', 'path': 'Line_resources/line51.xlsx'},
    {'name': 'Line_resources/line50.xlsx', 'path': 'Line_resources/line50.xlsx'},
    {'name': 'Line_resources/line49.xlsx', 'path': 'Line_resources/line49.xlsx'},
    {'name': 'Line_resources/line48.xlsx', 'path': 'Line_resources/line48.xlsx'},
    {'name': 'Line_resources/line47.xlsx', 'path': 'Line_resources/line47.xlsx'},
    {'name': 'Line_resources/line46.xlsx', 'path': 'Line_resources/line46.xlsx'},
    {'name': 'Line_resources/line45.xlsx', 'path': 'Line_resources/line45.xlsx'},
    {'name': 'Line_resources/line44.xlsx', 'path': 'Line_resources/line44.xlsx'},
    {'name': 'Line_resources/line43.xlsx', 'path': 'Line_resources/line43.xlsx'},
    {'name': 'Line_resources/line42.xlsx', 'path': 'Line_resources/line42.xlsx'},
    {'name': 'Line_resources/line41.xlsx', 'path': 'Line_resources/line41.xlsx'},
    {'name': 'Line_resources/line40.xlsx', 'path': 'Line_resources/line40.xlsx'},
  ]
});
...
async function updateInfo() {
  ...
  psychoJS.experiment.dataFileName = (("." + "/") + `data/${expInfo["\u4e3b\u8bd5ID"]}_3_2_1_${expName}_${expInfo["\u7f16\u53f7"]}_${expInfo["date"]}`);
...
async function experimentInit() {
  ...
  title_2 = new visual.TextStim({
    ...
    font: 'Arial',
    units: 'norm', 
    pos: [0, (- 0.8)], height: 0.08,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('black'),  opacity: undefined,
    depth: -1.0 
  });
  ...
  scale_set_upClock = new util.Clock();
  ...
  text_top = new visual.TextStim({
    ...
    font: 'Arial',
    units: 'norm', 
    pos: [0, 0.7], height: 0.08,  wrapWidth: 1.5, ori: 0,
    languageStyle: 'LTR',
  ...
  text_bottom = new visual.TextStim({
    ...
    font: 'Arial',
    units: 'norm', 
    pos: [0, (- 0.6)], height: 0.05,  wrapWidth: 1.5, ori: 0,
    languageStyle: 'LTR',
    color: new util.Color('black'),  opacity: 1,
    depth: -2.0 
  });
  ...
  ccimage = new visual.ImageStim({
    ...
    image : 'Image/bank-1300155_640.png', mask : undefined,
    anchor : 'center',
  ...
  endcodeClock = new util.Clock();
  // Initialize components for Routine "output"
  outputClock = new util.Clock();
...
function TitleRoutineBegin(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('Title.started', globalClock.getTime());
    ...
    TitleComponents.push(title_2);
    TitleComponents.push(key_resp_3);
...
function TitleRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('Title.stopped', globalClock.getTime());
...
var scale_set_upComponents;
function scale_set_upRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'scale_set_up' ---
    t = 0;
    scale_set_upClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('scale_set_up.started', globalClock.getTime());
    key_resp_6.keys = undefined;
    key_resp_6.rt = undefined;
    _key_resp_6_allKeys = [];
    // keep track of which components have finished
    scale_set_upComponents = [];
    scale_set_upComponents.push(intro);
    scale_set_upComponents.push(key_resp_6);
    
    for (const thisComponent of scale_set_upComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function scale_set_upRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'scale_set_up' ---
    // get current time
    t = scale_set_upClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
...
function scale_set_upRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('scale_set_up.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
...
function rectangle_keysRoutineBegin(snapshot) {
  return async function () {
    ...
    t = 0;
    rectangle_keysClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('rectangle_keys.started', globalClock.getTime());
    ...
    rectangle_keysComponents.push(rectangle_text_keys);
    rectangle_keysComponents.push(polygon);
...
function rectangle_keysRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('rectangle_keys.stopped', globalClock.getTime());
    key_resp_keys.stop();
...
function Intro1RoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('Intro1.started', globalClock.getTime());
    key_resp_4.keys = undefined;
    key_resp_4.rt = undefined;
    _key_resp_4_allKeys = [];
    // keep track of which components have finished
    Intro1Components = [];
    Intro1Components.push(text_3);
    Intro1Components.push(key_resp_4);
...
function Intro1RoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('Intro1.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: 'Line_resources/loop1.xlsx',
...
function trials_2LoopBegin(trials_2LoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTrial_2 of trials_2) {
      ...
      trials_2LoopScheduler.add(routine_1RoutineBegin(snapshot));
      trials_2LoopScheduler.add(routine_1RoutineEachFrame());
      trials_2LoopScheduler.add(routine_1RoutineEnd(snapshot));
      ...
      trials_2LoopScheduler.add(endcodeRoutineBegin(snapshot));
      trials_2LoopScheduler.add(endcodeRoutineEachFrame());
      trials_2LoopScheduler.add(endcodeRoutineEnd(snapshot));
...
function trials_3LoopBegin(trials_3LoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTrial_3 of trials_3) {
      ...
      trials_3LoopScheduler.add(trial_2RoutineBegin(snapshot));
      trials_3LoopScheduler.add(trial_2RoutineEachFrame());
      trials_3LoopScheduler.add(trial_2RoutineEnd(snapshot));
...
function routine_1RoutineBegin(snapshot) {
  return async function () {
    ...
    count_cor_num = 0;
    Linefile = (("Line_resources/line" + Line.toString()) + ".xlsx");
...
function trial_2RoutineEachFrame() {
  return async function () {
    ...
    // *image_2* updates
    if (t >= 0.1 && image_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    if (key_resp_2.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_2.getKeys({keyList: ['left', 'right', 'up', 'down'], waitRelease: false});
...
function trial_2RoutineEnd(snapshot) {
  return async function () {
    ...
    console.log("Line=", Line, ",A=", A, ",B=", B, ",count=", count_cor_num);
...
var endcodeComponents;
function endcodeRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'endcode' ---
    t = 0;
    endcodeClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('endcode.started', globalClock.getTime());
    // keep track of which components have finished
    endcodeComponents = [];
    
    for (const thisComponent of endcodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function endcodeRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'endcode' ---
    // get current time
    t = endcodeClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    // check for quit (typically the Esc key)
    if (psychoJS.experiment.experimentEnded || psychoJS.eventManager.getKeys({keyList:['escape']}).length > 0) {
...
function endcodeRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('endcode.stopped', globalClock.getTime());
    // Run 'End Routine' code from code_5
    if ((breakcondition === 1)) {
        continueRoutine = false;
        trials_2.finished = true;
    }
    psychoJS.experiment.addData("FinalLine", Line);
    psychoJS.experiment.addData("A", A);
    psychoJS.experiment.addData("B", B);
...
function outputRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'output' ---
    t = 0;
    outputClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('output.started', globalClock.getTime());
    // Run 'Begin Routine' code from code_11
    msg = ("\u60a8\u7684\u7ed3\u679c\u662f\uff1a" + A.toString());
    ...
    // keep track of which components have finished
    outputComponents = [];
    outputComponents.push(text_6);
    outputComponents.push(text_7);
    outputComponents.push(key_resp_5);
    
    for (const thisComponent of outputComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function outputRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'output' ---
    // get current time
...
function outputRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('output.stopped', globalClock.getTime());
    // Run 'End Routine' code from code_11
    psychoJS.experiment.addData("\u89c6\u529b\u6700\u7ec8\u7ed3\u679c", A);
...
async function quitPsychoJS(message, isCompleted) {
  ...
  window.location.href = "https://experiment.psych.ac.cn/audition"; // 回到下段启动页面
